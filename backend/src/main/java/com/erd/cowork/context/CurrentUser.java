...
/**
 * Request-scoped holder for the caller identity, populated by {@link CurrentUserInterceptor} from
 * the {@code X-User-Id} header. Services inject this instead of threading a {@code userId}
