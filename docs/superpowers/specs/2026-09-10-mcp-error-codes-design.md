...
| 11 | Any other exception | `RETRYABLE` | `unexpected failure in deepagent calling '<id>.<tool>' (<exception class>); retry, and report it if it persists` — logged at ERROR with traceback |
